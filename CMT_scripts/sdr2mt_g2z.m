...
fprintf(fid,'PDE  2011 03 11 05 46 24.00 %8.2f %8.2f %6.2f mb Ms CMT\n', ...
    lat, lon, depth);
...
fprintf(fid,'Mrr:      %13.5fe+22\n', Mrr / Expo);
fprintf(fid,'Mtt:      %13.5fe+22\n', Mtt / Expo);
fprintf(fid,'Mpp:      %13.5fe+22\n', Mpp / Expo);
fprintf(fid,'Mrt:      %13.5fe+22\n', Mrt / Expo);
fprintf(fid,'Mrp:      %13.5fe+22\n', Mrp / Expo);
fprintf(fid,'Mtp:      %13.5fe+22\n', Mtp / Expo);
