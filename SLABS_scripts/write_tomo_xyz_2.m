...
F_vp = scatteredInterpolant(x, y, z, vp, 'linear', 'none');
F_vs = scatteredInterpolant(x, y, z, vs, 'linear', 'none');
F_rho = scatteredInterpolant(x, y, z, rho, 'linear', 'none');
...
%%
% figure;
% h = slice(Xq, Yq, Zq, Rho_uniform, mean(xq), mean(yq),0);
% title('Vp');
...
save 10kmgrid_uni_interpolated.mat
...
filename = 'full_tomo_10km_grid.xyz';
